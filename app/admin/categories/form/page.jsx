...
export default function Page() {
    ...
    return <main className="w-full p-6 flex flex-col gap-3">
        <div className="flex gap-5 items-center">
            ...
            <h1 className="font-bold text-white">Category | Form</h1>
        </div>
        <section className="flex">
            <form
                ...
                className="flex flex-col gap-2 bg-gray-700 rounded-xl p-7">
                <div className="flex flex-col gap-2">
                    <label className="text-sm text-gray-300">Category Name <span className="text-red-500">*</span> </label>
                    <input
                ...
                <div className="flex flex-col gap-2">
                    <label className="text-sm text-gray-300">Category Slug <span className="text-red-500">*</span> </label>
                    <input
                        className="px-4 py-2 rounded-full border bg-gray-300"
