        ...
        <table className="w-full text-center text-white">
            <thead>
                <tr>
                    ...
                    <th className="border px-4 py-2 bg-blue-900">Photo</th>
                    <th className="border px-4 py-2 bg-blue-900">Name</th>
                    <th className="border px-4 py-2 bg-blue-900">Email</th>
            ...
            <tbody>
                {data?.map((item, key) => {
                    return <tr >
                        ...
                        <td className="border px-4 py-2"> <img className="h-10 mx-auto" src={item?.photoURL} alt="" /> </td>
