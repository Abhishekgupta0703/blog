...
export default function Page() {
    ...
    return <main className="w-full p-6 flex flex-col gap-3">
        <div className="flex gap-5 items-center">
            ...
            {!updatePostId && <div className="flex">
                <h3 className="text-white bg-green-500 px-4 py-2 rounded-full  font-bold">Create</h3>
            </div>}
        ...
        <section className="flex gap-5">
            <form
                ...
                className="flex flex-col gap-2 bg-slate-700 rounded-xl p-7">
                <div className="flex flex-col gap-2">
                    <label className="text-sm text-gray-300">Title <span className="text-red-500">*</span> </label>
                    <input
                        className="px-4 py-2 rounded-full border bg-gray-300"
                ...
                <div className="flex flex-col gap-2">
                    <label className="text-sm text-gray-300">Post Slug <span className="text-red-500">*</span> </label>
                    <input
                        className="px-4 py-2 rounded-full border bg-gray-300"
...
function SelectCategoryField() {
    ...
    return <div className="flex flex-col gap-2">
        <label className="text-sm text-gray-300">Category  <span className="text-red-500">*</span> </label>
        <select
            className="px-4 py-2 rounded-full border bg-gray-300"
            name="category"
            id="category"
...
function SelectAuthorField() {
    ...
    return <div className="flex flex-col gap-2">
        <label className="text-sm text-gray-300">Authors  <span className="text-red-500">*</span> </label>
        <select
            className="px-4 py-2 rounded-full border bg-gray-300"
            name="authorId"
            id="authorId"
